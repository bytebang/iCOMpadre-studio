...
If you just want to test it then you can test the [latest version of iCOMpadre Studio](https://rawcdn.githack.com/bytebang/iCOMpadre-studio/main/media/index.html) here online.
